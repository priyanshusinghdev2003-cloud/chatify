...
function ChatHeader() {
    const {selectedUser,setSelectedUser,isTyping,senderTyping,senderStopTyping,setIsTyping}=useChatStore()
    ...
    >
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-green-400 text-xs">{isTyping && "Typing...."}</p>
        </div>
      </div>
